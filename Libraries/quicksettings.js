...
(function () {
    ...
    var QuickSettings = {
         ...
         * @returns {module:QuickSettings}
         */
        addButton: function (title, callback, container) {
